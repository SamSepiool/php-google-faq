    ...
    <body>
        ...
        <header>
            <div class="top">
                ...
                <img class='logo' src="img/googlelogo_clr_74x24px.svg" alt="">
        ...
        <main>
            ...
            <div class="container">
                ...
                <ul>
                    <?php foreach ($faqs as $element => $faqAnswer): ?>
                    <li class=question>
                        <h2><?= $faqAnswer['faq'] ?></h2>
